...
const projects = [
  {
    ...
    files: [
      { name: "BizBoost365 Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "BizBoost365 Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "BizBoost365 Logo.Zip", size: "2.02 MB", link: "#" },
